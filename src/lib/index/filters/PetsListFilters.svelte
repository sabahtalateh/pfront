...
{#if ($filters.load === 'loading')}
	{#if $page_loading_time > show_loader_after}
		<section class="loader-wrap" style="text-align: center">
			Загрузка... (сделать анимацию загрузочного текста или лого (собака и у неё немного перемещается поисковое стекло
			или
			шото отсюда https://freefrontend.com/css-loaders/))
		</section>
	{/if}
{:else }
